/* Cafe 0.0.87 Sat Mar 02 2013 19:05:06 GMT+0200 (EET) */
...
require.define('', {
/*ZB:  /async */
'async': function(exports, require, module) {(function() {
...
require.define('', {
/*ZB:  /breadcrumbs */
'breadcrumbs': function(exports, require, module) {(function() {
(function() {
  var animation, async, bs_item_s, bs_static, get_outer_width, get_show_hide_items, init, process, show_expander, toggle_items;
  ...
  process = function(_arg) {
    ...
    if (result_width > allowed_width) {
      ...
      return $(expander).click(function(ev) {
        var hide_from_head_visible, hide_from_tail_head_visible, show_from_tail_visible;
        if (from_head === true) {
          ...
          hide_from_tail_head_visible = function(cb) {
            return toggle_items(from_tail_show_items, animation, "hide", function() {
              return cb();
            });
          };
          show_from_head;

          return async.series([hide_from_tail_head_visible], function() {
